...
public abstract class Enemy extends Entity {
    ...
    public Enemy(World world, int health, Vector2 spawnPosition, Vector2 bodyDimension, Vector2 speed,
                 AttackBehaviour attackBehaviour, MovementBehaviour movementBehaviour) {
